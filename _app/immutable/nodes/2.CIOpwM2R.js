import"../chunks/DsnmJJEf.js";import"../chunks/BcbL0YC6.js";import{B as ka,w as la,z as Ve,o as X,ay as Qa,q as ja,g as s,W as Ja,x as el,H as al,y as da,A as me,J as De,ad as ll,aG as nl,C as Te,F as sl,D as he,ac as fa,a4 as H,aa as va,aD as Da,av as Aa,aR as Ie,G as ma,I as rl,aS as He,aT as tl,aU as Ue,al as we,ar as ol,aV as il,aC as ul,aW as Fl,T as cl,aX as Ta,M as dl,aY as fl,K as wa,aZ as vl,a_ as hl,at as gl,a$ as pl,b0 as bl,b1 as _l,b2 as Cl,b3 as Bl,b4 as kl,b5 as Dl,b6 as Al,b7 as ml,U as Tl,b8 as wl,a6 as Ma,b as V,L as Ml,b9 as El,i as j,t as de,k as z,m as E,n as w,p as na,ba as xe,R as T,e as ge,bb as Ea,v as ze,j as We,l as sa,bc as Xe,s as I,am as ha,bd as ya,be as yl}from"../chunks/C6FDjAM0.js";import{i as Sl,c as Pl,d as Ll,n as Gl,a as Ol,b as Sa,e as q,s as Ze,f as xl}from"../chunks/D4-iEtvf.js";import{p as W,i as Fe,b as Pa}from"../chunks/DWEwxHGK.js";import{i as ra}from"../chunks/D1GnaSS7.js";function Ge(e,n){return n}function Il(e,n,a){for(var l=e.items,r=[],t=n.length,o=0;o<t;o++)il(n[o].e,r,!0);var F=t>0&&r.length===0&&a!==null;if(F){var u=a.parentNode;ul(u),u.append(a),l.clear(),se(e,n[0].prev,n[t-1].next)}Fl(r,()=>{for(var d=0;d<t;d++){var b=n[d];F||(l.delete(b.k),se(e,b.prev,b.next)),we(b.e,!F)}})}function Oe(e,n,a,l,r,t=null){var o=e,F={flags:n,items:new Map,first:null},u=(n&Ta)!==0;if(u){var d=e;o=X?Ve(Qa(d)):d.appendChild(ka())}X&&ja();var b=null,p=!1,v=new Map,D=Ja(()=>{var m=a();return Aa(m)?m:m==null?[]:Da(m)}),f,C;function g(){Hl(C,f,F,v,o,r,n,l,a),t!==null&&(f.length===0?b?ma(b):b=Te(()=>t(o)):b!==null&&rl(b,()=>{b=null}))}la(()=>{C??=cl,f=s(D);var m=f.length;if(p&&m===0)return;p=m===0;let M=!1;if(X){var L=el(o)===al;L!==(m===0)&&(o=da(),Ve(o),me(!1),M=!0)}if(X){for(var k=null,h,i=0;i<m;i++){if(De.nodeType===ll&&De.data===nl){o=De,M=!0,me(!1);break}var c=f[i],A=l(c,i);h=ea(De,F,k,null,c,A,i,r,n,a),F.items.set(A,h),k=h}m>0&&Ve(da())}if(X)m===0&&t&&(b=Te(()=>t(o)));else if(sl()){var x=new Set,S=he;for(i=0;i<m;i+=1){c=f[i],A=l(c,i);var N=F.items.get(A)??v.get(A);N?(n&(He|Ie))!==0&&La(N,c,i,n):(h=ea(null,F,null,null,c,A,i,r,n,a,!0),v.set(A,h)),x.add(A)}for(const[G,_]of F.items)x.has(G)||S.skipped_effects.add(_.e);S.add_callback(g)}else g();M&&me(!0),s(D)}),X&&(o=De)}function Hl(e,n,a,l,r,t,o,F,u){var d=(o&fl)!==0,b=(o&(He|Ie))!==0,p=n.length,v=a.items,D=a.first,f=D,C,g=null,m,M=[],L=[],k,h,i,c;if(d)for(c=0;c<p;c+=1)k=n[c],h=F(k,c),i=v.get(h),i!==void 0&&(i.a?.measure(),(m??=new Set).add(i));for(c=0;c<p;c+=1){if(k=n[c],h=F(k,c),i=v.get(h),i===void 0){var A=l.get(h);if(A!==void 0){l.delete(h),v.set(h,A);var x=g?g.next:f;se(a,g,A),se(a,A,x),$e(A,x,r),g=A}else{var S=f?f.e.nodes_start:r;g=ea(S,a,g,g===null?a.first:g.next,k,h,c,t,o,u)}v.set(h,g),M=[],L=[],f=g.next;continue}if(b&&La(i,k,c,o),(i.e.f&Ue)!==0&&(ma(i.e),d&&(i.a?.unfix(),(m??=new Set).delete(i))),i!==f){if(C!==void 0&&C.has(i)){if(M.length<L.length){var N=L[0],G;g=N.prev;var _=M[0],B=M[M.length-1];for(G=0;G<M.length;G+=1)$e(M[G],N,r);for(G=0;G<L.length;G+=1)C.delete(L[G]);se(a,_.prev,B.next),se(a,g,_),se(a,B,N),f=N,g=B,c-=1,M=[],L=[]}else C.delete(i),$e(i,f,r),se(a,i.prev,i.next),se(a,i,g===null?a.first:g.next),se(a,g,i),g=i;continue}for(M=[],L=[];f!==null&&f.k!==h;)(f.e.f&Ue)===0&&(C??=new Set).add(f),L.push(f),f=f.next;if(f===null)continue;i=f}M.push(i),g=i,f=i.next}if(f!==null||C!==void 0){for(var P=C===void 0?[]:Da(C);f!==null;)(f.e.f&Ue)===0&&P.push(f),f=f.next;var U=P.length;if(U>0){var R=(o&Ta)!==0&&p===0?r:null;if(d){for(c=0;c<U;c+=1)P[c].a?.measure();for(c=0;c<U;c+=1)P[c].a?.fix()}Il(a,P,R)}}d&&dl(()=>{if(m!==void 0)for(i of m)i.a?.apply()}),e.first=a.first&&a.first.e,e.last=g&&g.e;for(var ee of l.values())we(ee.e);l.clear()}function La(e,n,a,l){(l&He)!==0&&fa(e.v,n),(l&Ie)!==0?fa(e.i,a):e.i=a}function ea(e,n,a,l,r,t,o,F,u,d,b){var p=(u&He)!==0,v=(u&tl)===0,D=p?v?H(r,!1,!1):va(r):r,f=(u&Ie)===0?o:va(o),C={i:f,v:D,k:t,a:null,e:null,prev:a,next:l};try{if(e===null){var g=document.createDocumentFragment();g.append(e=ka())}return C.e=Te(()=>F(e,D,f,d),X),C.e.prev=a&&a.e,C.e.next=l&&l.e,a===null?b||(n.first=C):(a.next=C,a.e.next=C.e),l!==null&&(l.prev=C,l.e.prev=C.e),C}finally{}}function $e(e,n,a){for(var l=e.next?e.next.e.nodes_start:a,r=n?n.e.nodes_start:a,t=e.e.nodes_start;t!==null&&t!==l;){var o=ol(t);r.before(t),t=o}}function se(e,n,a){n===null?e.first=a:(n.next=a,n.e.next=a&&a.e),a!==null&&(a.prev=n,a.e.prev=n&&n.e)}function Nl(e,n){var a=void 0,l;la(()=>{a!==(a=n())&&(l&&(we(l),l=null),a&&(l=Te(()=>{wa(()=>a(e))})))})}function Ga(e){var n,a,l="";if(typeof e=="string"||typeof e=="number")l+=e;else if(typeof e=="object")if(Array.isArray(e)){var r=e.length;for(n=0;n<r;n++)e[n]&&(a=Ga(e[n]))&&(l&&(l+=" "),l+=a)}else for(a in e)e[a]&&(l&&(l+=" "),l+=a);return l}function Rl(){for(var e,n,a=0,l="",r=arguments.length;a<r;a++)(e=arguments[a])&&(n=Ga(e))&&(l&&(l+=" "),l+=n);return l}function Yl(e){return typeof e=="object"?Rl(e):e??""}const ga=[...` 	
\r\f \v\uFEFF`];function ql(e,n,a){var l=e==null?"":""+e;if(n&&(l=l?l+" "+n:n),a){for(var r in a)if(a[r])l=l?l+" "+r:r;else if(l.length)for(var t=r.length,o=0;(o=l.indexOf(r,o))>=0;){var F=o+t;(o===0||ga.includes(l[o-1]))&&(F===l.length||ga.includes(l[F]))?l=(o===0?"":l.substring(0,o))+l.substring(F+1):o=F}}return l===""?null:l}function pa(e,n=!1){var a=n?" !important;":";",l="";for(var r in e){var t=e[r];t!=null&&t!==""&&(l+=" "+r+": "+t+a)}return l}function Ke(e){return e[0]!=="-"||e[1]!=="-"?e.toLowerCase():e}function Vl(e,n){if(n){var a="",l,r;if(Array.isArray(n)?(l=n[0],r=n[1]):l=n,e){e=String(e).replaceAll(/\s*\/\*.*?\*\/\s*/g,"").trim();var t=!1,o=0,F=!1,u=[];l&&u.push(...Object.keys(l).map(Ke)),r&&u.push(...Object.keys(r).map(Ke));var d=0,b=-1;const C=e.length;for(var p=0;p<C;p++){var v=e[p];if(F?v==="/"&&e[p-1]==="*"&&(F=!1):t?t===v&&(t=!1):v==="/"&&e[p+1]==="*"?F=!0:v==='"'||v==="'"?t=v:v==="("?o++:v===")"&&o--,!F&&t===!1&&o===0){if(v===":"&&b===-1)b=p;else if(v===";"||p===C-1){if(b!==-1){var D=Ke(e.substring(d,b).trim());if(!u.includes(D)){v!==";"&&p++;var f=e.substring(d,p).trim();a+=" "+f+";"}}d=p+1,b=-1}}}}return l&&(a+=pa(l)),r&&(a+=pa(r,!0)),a=a.trim(),a===""?null:a}return e==null?null:String(e)}function ue(e,n,a,l,r,t){var o=e.__className;if(X||o!==a||o===void 0){var F=ql(a,l,t);(!X||F!==e.getAttribute("class"))&&(F==null?e.removeAttribute("class"):n?e.className=F:e.setAttribute("class",F)),e.__className=a}else if(t&&r!==t)for(var u in t){var d=!!t[u];(r==null||d!==!!r[u])&&e.classList.toggle(u,d)}return t}function Qe(e,n={},a,l){for(var r in a){var t=a[r];n[r]!==t&&(a[r]==null?e.style.removeProperty(r):e.style.setProperty(r,t,l))}}function pe(e,n,a,l){var r=e.__style;if(X||r!==n){var t=Vl(n,l);(!X||t!==e.getAttribute("style"))&&(t==null?e.removeAttribute("style"):e.style.cssText=t),e.__style=n}else l&&(Array.isArray(l)?(Qe(e,a?.[0],l[0]),Qe(e,a?.[1],l[1],"important")):Qe(e,a,l));return l}function aa(e,n,a=!1){if(e.multiple){if(n==null)return;if(!Aa(n))return vl();for(var l of e.options)l.selected=n.includes(ba(l));return}for(l of e.options){var r=ba(l);if(hl(r,n)){l.selected=!0;return}}(!a||n!==void 0)&&(e.selectedIndex=-1)}function Ul(e){var n=new MutationObserver(()=>{aa(e,e.__value)});n.observe(e,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["value"]}),gl(()=>{n.disconnect()})}function ba(e){return"__value"in e?e.__value:e.value}const Le=Symbol("class"),Ae=Symbol("style"),Oa=Symbol("is custom element"),xa=Symbol("is html");function Ia(e){if(X){var n=!1,a=()=>{if(!n){if(n=!0,e.hasAttribute("value")){var l=e.value;Y(e,"value",null),e.value=l}if(e.hasAttribute("checked")){var r=e.checked;Y(e,"checked",null),e.checked=r}}};e.__on_r=a,Bl(a),kl()}}function zl(e,n){n?e.hasAttribute("selected")||e.setAttribute("selected",""):e.removeAttribute("selected")}function Y(e,n,a,l){var r=Ha(e);X&&(r[n]=e.getAttribute(n),n==="src"||n==="srcset"||n==="href"&&e.nodeName==="LINK")||r[n]!==(r[n]=a)&&(n==="loading"&&(e[pl]=a),a==null?e.removeAttribute(n):typeof a!="string"&&Na(e).includes(n)?e[n]=a:e.setAttribute(n,a))}function Wl(e,n,a,l,r=!1,t=!1){if(X&&r&&e.tagName==="INPUT"){var o=e,F=o.type==="checkbox"?"defaultChecked":"defaultValue";F in a||Ia(o)}var u=Ha(e),d=u[Oa],b=!u[xa];let p=X&&d;p&&me(!1);var v=n||{},D=e.tagName==="OPTION";for(var f in n)f in a||(a[f]=null);a.class?a.class=Yl(a.class):a.class=null,a[Ae]&&(a.style??=null);var C=Na(e);for(const i in a){let c=a[i];if(D&&i==="value"&&c==null){e.value=e.__value="",v[i]=c;continue}if(i==="class"){var g=e.namespaceURI==="http://www.w3.org/1999/xhtml";ue(e,g,c,l,n?.[Le],a[Le]),v[i]=c,v[Le]=a[Le];continue}if(i==="style"){pe(e,c,n?.[Ae],a[Ae]),v[i]=c,v[Ae]=a[Ae];continue}var m=v[i];if(!(c===m&&!(c===void 0&&e.hasAttribute(i)))){v[i]=c;var M=i[0]+i[1];if(M!=="$$")if(M==="on"){const A={},x="$$"+i;let S=i.slice(2);var L=Ol(S);if(Sl(S)&&(S=S.slice(0,-7),A.capture=!0),!L&&m){if(c!=null)continue;e.removeEventListener(S,v[x],A),v[x]=null}if(c!=null)if(L)e[`__${S}`]=c,Ll([S]);else{let N=function(G){v[i].call(this,G)};v[x]=Pl(S,e,N,A)}else L&&(e[`__${S}`]=void 0)}else if(i==="style")Y(e,i,c);else if(i==="autofocus")ml(e,!!c);else if(!d&&(i==="__value"||i==="value"&&c!=null))e.value=e.__value=c;else if(i==="selected"&&D)zl(e,c);else{var k=i;b||(k=Gl(k));var h=k==="defaultValue"||k==="defaultChecked";if(c==null&&!d&&!h)if(u[i]=null,k==="value"||k==="checked"){let A=e;const x=n===void 0;if(k==="value"){let S=A.defaultValue;A.removeAttribute(k),A.defaultValue=S,A.value=A.__value=x?S:null}else{let S=A.defaultChecked;A.removeAttribute(k),A.defaultChecked=S,A.checked=x?S:!1}}else e.removeAttribute(i);else h||C.includes(k)&&(d||typeof c!="string")?(e[k]=c,k in u&&(u[k]=Tl)):typeof c!="function"&&Y(e,k,c)}}}return p&&me(!0),v}function Xl(e,n,a=[],l=[],r,t=!1,o=!1){Dl(a,l,F=>{var u=void 0,d={},b=e.nodeName==="SELECT",p=!1;if(la(()=>{var D=n(...F.map(s)),f=Wl(e,u,D,r,t,o);p&&b&&"value"in D&&aa(e,D.value);for(let g of Object.getOwnPropertySymbols(d))D[g]||we(d[g]);for(let g of Object.getOwnPropertySymbols(D)){var C=D[g];g.description===Al&&(!u||C!==u[g])&&(d[g]&&we(d[g]),d[g]=Te(()=>Nl(e,()=>C))),f[g]=C}u=f}),b){var v=e;wa(()=>{aa(v,u.value,!0),Ul(v)})}p=!0})}function Ha(e){return e.__attributes??={[Oa]:e.nodeName.includes("-"),[xa]:e.namespaceURI===bl}}var _a=new Map;function Na(e){var n=e.getAttribute("is")||e.nodeName,a=_a.get(n);if(a)return a;_a.set(n,a=[]);for(var l,r=e,t=Element.prototype;t!==r;){l=Cl(r);for(var o in l)l[o].set&&a.push(o);r=_l(r)}return a}function Zl(e,n,a=n){var l=new WeakSet;wl(e,"input",async r=>{var t=r?e.defaultValue:e.value;if(t=je(e)?Je(t):t,a(t),he!==null&&l.add(he),await Ma(),t!==(t=n())){var o=e.selectionStart,F=e.selectionEnd;e.value=t??"",F!==null&&(e.selectionStart=o,e.selectionEnd=Math.min(F,e.value.length))}}),(X&&e.defaultValue!==e.value||V(n)==null&&e.value)&&(a(je(e)?Je(e.value):e.value),he!==null&&l.add(he)),Ml(()=>{var r=n();if(e===document.activeElement){var t=El??he;if(l.has(t))return}je(e)&&r===Je(e.value)||e.type==="date"&&!r&&!e.value||r!==e.value&&(e.value=r??"")})}function je(e){var n=e.type;return n==="number"||n==="range"}function Je(e){return e===""?null:+e}var $l=j('<div class="square svelte-gxsx5p"></div>');function Ra(e,n){let a=W(n,"color",8,"#000");var l=$l();de(()=>pe(l,`--color: ${a()??""}`)),z(e,l)}var Kl=j('<div class="circle svelte-r5z0cw"></div>');function Ya(e,n){let a=W(n,"color",8,"#000");var l=Kl();de(()=>pe(l,`--color: ${a()??""}`)),z(e,l)}var Ql=j('<div class="arch-container svelte-1isloo0"><svg width="100%" height="100%" viewBox="0 0 100 100" preserveAspectRatio="none"><circle cx="0" cy="0" r="100"></circle></svg></div>');function qa(e,n){let a=W(n,"color",8,"#000"),l=W(n,"rotation",8,0);var r=Ql(),t=E(r),o=E(t);w(t),w(r),de(()=>{pe(r,`transform: rotate(${l()*90}deg);`),Y(o,"fill",a())}),z(e,r)}const jl=`Part,Color,Quantity,Is Spare
3070b,0,4,False
25269,0,12,False
3710,212,6,False
3070b,212,10,False
...
`);for(const r of l.slice(1)){const t=r.split(",");if(t.length>1){const o=Number(t[1]);isNaN(o)||e.add(o)}}}return e}const Fn=un(),ie=rn(sn).filter(e=>Fn.has(e.id));function cn(){return ie.map(e=>{const n=tn(e.rgb);return{...e,...n}})}const dn=on(cn());var fn=j('<div class="cell svelte-1w4104m" role="button" tabindex="0"><!></div>'),vn=j("<div><div></div></div>");function Ba(e,n){na(n,!1);const a=Sa();let l=W(n,"grid",8,null),r=W(n,"width",8,32),t=W(n,"height",8,32),o=W(n,"selectedShape",8,"square"),F=W(n,"selectedColor",24,()=>ie.length>0?ie[0].rgb:"#000000"),u=W(n,"paintMode",8,!1),d=W(n,"colorPickerMode",8,!1),b=W(n,"toolbarPosition",8,"left"),p=H(),v=W(n,"zoom",12,1),D=H(0),f=H(0),C=H(!1),g=H(0),m=H(0),M=H();function L(_){if(_.ctrlKey)return;_.preventDefault();const B=.1;let P=v();_.deltaY<0?P=Math.min(v()+B,5):_.deltaY>0&&(P=Math.max(v()-B,.2)),P!==v()&&v(P)}function k(_){_.button===0&&(T(C,!0),T(g,_.clientX),T(m,_.clientY),window.addEventListener("mousemove",h),window.addEventListener("mouseup",i),_.preventDefault())}function h(_){s(C)&&(T(D,s(D)+(_.clientX-s(g))),T(f,s(f)+(_.clientY-s(m))),T(g,_.clientX),T(m,_.clientY))}function i(){T(C,!1),window.removeEventListener("mousemove",h),window.removeEventListener("mouseup",i)}let c=H(v());function A(_){const B=s(p)[_];if(!B)return x(_);const{shape:P,color:U}=B;if(P===o()&&U===F())return;const R=[_],ee=new Set;for(;R.length;){const O=R.pop();if(O===void 0||ee.has(O))continue;ee.add(O);const Q=s(p)[O];if(!Q||Q.shape!==P||Q.color!==U)continue;Xe(p,s(p)[O]={shape:o(),color:F(),rotation:0});const ae=O%r(),fe=Math.floor(O/r());ae>0&&R.push(O-1),ae<r()-1&&R.push(O+1),fe>0&&R.push(O-r()),fe<t()-1&&R.push(O+r())}T(p,[...s(p)])}function x(_){const B=s(p)[_];B&&B.shape==="arch"&&B.color===F()?Xe(p,s(p)[_]={...B,rotation:(B.rotation+1)%4}):Xe(p,s(p)[_]={shape:o(),color:F(),rotation:0}),T(p,[...s(p)])}function S(_){const B=s(p)[_];B&&B.color&&a("colorPicked",{color:B.color})}xe(()=>(ge(l()),ge(r()),ge(t())),()=>{T(p,l()||Array(r()*t()).fill(null))}),xe(()=>(ge(v()),s(c),s(M),s(D),s(f)),()=>{if(v()!==s(c)&&s(M)){const _=s(M).parentElement;if(_){const B=_.getBoundingClientRect(),P=B.left+B.width/2,U=B.top+B.height/2,R=s(M).getBoundingClientRect(),ee=R.left+R.width/2,O=R.top+R.height/2,Q=P-ee,ae=U-O;T(D,s(D)+(Q-Q*(v()/s(c)))),T(f,s(f)+(ae-ae*(v()/s(c))))}T(c,v())}}),Ea(),ra();var N=vn(),G=E(N);Xl(G,()=>({class:"grid",role:"application","aria-label":"Drawing canvas",tabindex:"0",style:`--width: ${r()??""}; --height: ${t()??""}; transform: translate(${s(D)??""}px, ${s(f)??""}px) scale(${v()??""}); cursor: ${s(C)?"grabbing":"grab"}; user-select: none; touch-action: none;`,"on:mousedown":k,"on:keydown":_=>{_.key===" "&&(_.preventDefault(),k({button:0,clientX:s(g),clientY:s(m),preventDefault:()=>{}}))},"on:keyup":_=>{_.key===" "&&(_.preventDefault(),i())},"on:wheel":L}),void 0,void 0,"svelte-1w4104m"),Oe(G,5,()=>s(p),Ge,(_,B,P)=>{var U=fn(),R=E(U);{var ee=O=>{var Q=ze(),ae=We(Q);{var fe=re=>{Ra(re,{get color(){return s(B),V(()=>s(B).color)}})},be=re=>{var _e=ze(),Me=We(_e);{var ce=le=>{Ya(le,{get color(){return s(B),V(()=>s(B).color)}})},Ee=le=>{var ve=ze(),ye=We(ve);{var Ce=Be=>{qa(Be,{get color(){return s(B),V(()=>s(B).color)},get rotation(){return s(B),V(()=>s(B).rotation)}})};Fe(ye,Be=>{s(B),V(()=>s(B).shape==="arch")&&Be(Ce)},!0)}z(le,ve)};Fe(Me,le=>{s(B),V(()=>s(B).shape==="circle")?le(ce):le(Ee,!1)},!0)}z(re,_e)};Fe(ae,re=>{s(B),V(()=>s(B).shape==="square")?re(fe):re(be,!1)})}z(O,Q)};Fe(R,O=>{s(B)&&O(ee)})}w(U),q("click",U,()=>d()?S(P):u()?A(P):x(P)),q("keydown",U,O=>{O.key==="Enter"&&(d()?S(P):u()?A(P):x(P))}),z(_,U)}),w(G),Pa(G,_=>T(M,_),()=>s(M)),w(N),de(()=>ue(N,1,`container ${b()==="left"?"toolbar-left-margin":"toolbar-top-margin"}`,"svelte-1w4104m")),q("mousedown",G,k),q("keydown",G,_=>{_.key===" "&&(_.preventDefault(),k({button:0,clientX:s(g),clientY:s(m),preventDefault:()=>{}}))}),q("keyup",G,_=>{_.key===" "&&(_.preventDefault(),i())}),q("wheel",G,L),z(e,N),sa()}var hn=ya('<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#555" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align: middle;"><polyline points="4 12 4 4 12 4"></polyline><line x1="4" y1="4" x2="20" y2="20"></line></svg>'),gn=ya('<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#555" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align: middle;"><polyline points="12 4 20 4 20 12"></polyline><line x1="4" y1="4" x2="20" y2="20"></line></svg>'),pn=j('<button type="button" class="dropdown-item" style="display: flex; align-items: center; width: 100%; background: none; border: none; padding: 0; text-align: left; cursor: pointer;"><span class="dropdown-swatch"></span> <span> </span> <span style="margin-left:auto; color:#888; font-size:0.9em"> </span></button>'),bn=j('<div class="dropdown-item">No colors found</div>'),_n=j('<div class="dropdown-menu"><input type="text" placeholder="Search color..." class="dropdown-search"/> <div class="dropdown-list"><!> <!></div></div>'),Cn=j('<button type="button"></button>'),Bn=j('<div class="palette-row"></div>'),kn=j('<div><button class="toolbar-toggle"><!></button> <div class="shape-group"><div class="group-label">Shapes</div> <div class="shape-grid"><button aria-label="Square" title="Square - Draw square shapes"><div class="shape-icon"><!></div></button> <button aria-label="Circle" title="Circle - Draw circular shapes"><div class="shape-icon"><!></div></button> <button aria-label="Arch" title="Arch - Draw arch shapes"><div class="shape-icon"><!></div></button></div></div> <div class="tool-group"><div class="group-label">Tools</div> <div class="tool-grid"><button type="button" aria-label="Zoom in" class="tool-button" title="Zoom In"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#555" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="11" y1="8" x2="11" y2="14"></line><line x1="8" y1="11" x2="14" y2="11"></line><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg></button> <button type="button" aria-label="Zoom out" class="tool-button" title="Zoom Out"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#555" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="8" y1="11" x2="14" y2="11"></line><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg></button> <button type="button" aria-label="Paint roller tool" title="Fill Tool - Fill areas with selected color"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="6" y="4" width="10" height="4" rx="1.5"></rect><path d="M16 6v4c0 1-1 2-2 2H10c-1 0-2-1-2-2V6"></path><rect x="11" y="14" width="2" height="5" rx="1"></rect><path d="M12 12v2"></path></svg></button> <button type="button" aria-label="Pick color from canvas" title="Color Picker - Click to pick colors from the canvas"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="7" stroke-width="2"></circle><path d="M12 9v3l2 2" stroke-width="2"></path></svg></button></div></div> <div class="color-dropdown-container"><button type="button" class="dropdown-toggle"> <span style="margin-left:0.5em;">▼</span></button> <!></div> <div class="colors"><div class="palette2d"></div></div> <div class="image-upload"><label class="upload-label"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#555" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align: middle;"><path d="M12 16V4"></path><polyline points="8 8 12 4 16 8"></polyline><rect x="4" y="16" width="16" height="4" rx="2"></rect></svg> <span>Upload image</span> <input type="file" accept="image/png, image/jpeg"/></label></div></div>');function Dn(e,n){na(n,!1);let a=H(null),l=H(!1),r=W(n,"colorPickerMode",12,!1);function t(){T(l,!s(l)),s(l)&&r(!1),u("paintModeToggled",{paintMode:s(l)})}function o(){r(!r()),r()&&T(l,!1),u("colorPickerModeToggled",{colorPickerMode:r()})}function F(y){b(y),u("colorSelected",{color:y})}const u=Sa();let d=W(n,"selectedShape",12,"square"),b=W(n,"selectedColor",28,()=>ie.length>0?ie[0].rgb:"#000000");function p(y){d(y),u("shapeSelected",{shape:y})}function v(y){const Z=y.target,K=Z.files&&Z.files[0];if(K){const ne=new FileReader;ne.onload=()=>{u("imageUploaded",{src:ne.result})},ne.readAsDataURL(K)}}let D=H(""),f=H(!1),C=ie,g=H(C);function m(y){b(y.rgb),T(f,!1),T(D,""),u("colorSelected",{color:y.rgb})}let M=H("left");function L(){T(M,s(M)==="left"?"top":"left")}xe(()=>(s(f),s(a)),()=>{s(f)&&Ma().then(()=>{s(a)?.focus()})}),xe(()=>s(D),()=>{T(g,s(D).trim()?C.filter(y=>y.name.toLowerCase().includes(s(D).toLowerCase())||y.rgb.replace("#","").includes(s(D).replace("#",""))):C)}),Ea(),ra();var k=kn(),h=E(k),i=E(h);{var c=y=>{var Z=hn();z(y,Z)},A=y=>{var Z=gn();z(y,Z)};Fe(i,y=>{s(M)==="left"?y(c):y(A,!1)})}w(h);var x=I(h,2),S=I(E(x),2),N=E(S);let G;var _=E(N),B=E(_);Ra(B,{get color(){return b()}}),w(_),w(N);var P=I(N,2);let U;var R=E(P),ee=E(R);Ya(ee,{get color(){return b()}}),w(R),w(P);var O=I(P,2);let Q;var ae=E(O),fe=E(ae);qa(fe,{get color(){return b()},rotation:0}),w(ae),w(O),w(S),w(x);var be=I(x,2),re=I(E(be),2),_e=E(re),Me=I(_e,2),ce=I(Me,2);let Ee;var le=E(ce),ve=E(le),ye=I(ve),Ce=I(ye),Be=I(Ce);w(le),w(ce);var Se=I(ce,2);let ta;var Ne=E(Se),Va=E(Ne);ha(),w(Ne),w(Se),w(re),w(be);var Re=I(be,2),Pe=E(Re),Ua=E(Pe);ha(),w(Pe);var za=I(Pe,2);{var Wa=y=>{var Z=_n(),K=E(Z);Ia(K),Pa(K,oe=>T(a,oe),()=>s(a));var ne=I(K,2),$=E(ne);Oe($,1,()=>s(g),Ge,(oe,J)=>{var ke=pn(),Fa=E(ke),qe=I(Fa,2),$a=E(qe,!0);w(qe);var ca=I(qe,2),Ka=E(ca,!0);w(ca),w(ke),de(()=>{Y(ke,"aria-label",(s(J),V(()=>`Select color ${s(J).name}`))),pe(Fa,`background:${s(J),V(()=>s(J).rgb)??""}`),Ze($a,(s(J),V(()=>s(J).name))),Ze(Ka,(s(J),V(()=>s(J).rgb)))}),q("click",ke,()=>m(s(J))),z(oe,ke)});var te=I($,2);{var Za=oe=>{var J=bn();z(oe,J)};Fe(te,oe=>{s(g),V(()=>s(g).length===0)&&oe(Za)})}w(ne),w(Z),Zl(K,()=>s(D),oe=>T(D,oe)),z(y,Z)};Fe(za,y=>{s(f)&&y(Wa)})}w(Re);var Ye=I(Re,2),oa=E(Ye);Oe(oa,5,()=>dn,Ge,(y,Z)=>{var K=Bn();Oe(K,5,()=>s(Z),Ge,(ne,$)=>{var te=Cn();de(()=>{pe(te,`width: 1.5rem; height: 1.5rem; background: ${s($),V(()=>s($).rgb)??""}; border: 2px solid ${ge(b()),s($),V(()=>b()===s($).rgb?"#333":"#ccc")??""}; border-radius: 0.25rem; cursor: pointer; margin: 0 0.1rem 0.1rem 0;`),Y(te,"aria-label",(s($),V(()=>s($).name))),Y(te,"title",(s($),V(()=>s($).name)))}),q("click",te,()=>F(s($).rgb)),z(ne,te)}),w(K),z(y,K)}),w(oa),w(Ye);var ia=I(Ye,2),ua=E(ia),Xa=I(E(ua),4);w(ua),w(ia),w(k),de((y,Z,K,ne,$,te)=>{ue(k,1,`toolbar ${s(M)??""}`),Y(h,"aria-label",s(M)==="left"?"Move toolbar to top":"Move toolbar to left"),G=ue(N,1,"shape-button",null,G,y),U=ue(P,1,"shape-button",null,U,Z),Q=ue(O,1,"shape-button",null,Q,K),Ee=ue(ce,1,"tool-button",null,Ee,ne),Y(le,"stroke",s(l)?"#333":"#888"),Y(ve,"fill",s(l)?"#f4d23e":"#fff"),Y(ve,"stroke",s(l)?"#333":"#888"),Y(ye,"stroke",s(l)?"#333":"#888"),Y(Ce,"fill",s(l)?"#f4d23e":"#fff"),Y(Ce,"stroke",s(l)?"#333":"#888"),Y(Be,"stroke",s(l)?"#333":"#888"),ta=ue(Se,1,"tool-button",null,ta,$),Y(Ne,"stroke",r()?"#333":"#888"),Y(Va,"fill",r()?"#aef":"#fff"),Ze(Ua,`${te??""} `)},[()=>({selected:d()==="square"}),()=>({selected:d()==="circle"}),()=>({selected:d()==="arch"}),()=>({active:s(l)}),()=>({active:r()}),()=>(ge(b()),V(()=>b()?C.find(y=>y.rgb===b())?.name||b():"Select color..."))]),q("click",h,L),q("click",N,()=>p("square")),q("click",P,()=>p("circle")),q("click",O,()=>p("arch")),q("click",_e,()=>u("zoomIn")),q("click",Me,()=>u("zoomOut")),q("click",ce,t),q("click",Se,o),q("click",Pe,()=>T(f,!s(f))),q("change",Xa,v),z(e,k),sa()}function An(e){e=e.replace(/^#/,""),e.length===3&&(e=e.split("").map(a=>a+a).join(""));const n=parseInt(e,16);return{r:n>>16&255,g:n>>8&255,b:n&255}}function mn(e,n,a,l){let r=l[0],t=1/0;for(const o of l){const F=An(o),u=Math.sqrt(Math.pow(e-F.r,2)+Math.pow(n-F.g,2)+Math.pow(a-F.b,2));u<t&&(t=u,r=o)}return r}function Tn(e){return e<85?"square":e<170?"arch":"circle"}function wn(e,n,a=32,l=32){return new Promise((r,t)=>{const o=new window.Image;o.src=e,o.onload=()=>{const F=document.createElement("canvas"),u=F.getContext("2d");if(F.width=a,F.height=l,!u){t(new Error("Could not get 2D context"));return}u.drawImage(o,0,0,a,l);const d=u.getImageData(0,0,a,l).data,b=[];for(let p=0;p<d.length;p+=4){const v=p/4,D=v%a,f=Math.floor(v/a);let C=d[p],g=d[p+1],m=d[p+2];d[p+3]===0&&(C=255,g=255,m=255);const L=(C+g+m)/3;let k=Tn(L),h=0;const i=f===0,c=f===l-1,A=D===0,x=D===a-1;k==="arch"&&(i||c||A||x)?i?h=2:c?h=0:A?h=1:x&&(h=3):k==="arch"&&(k=L<128?"square":"circle");const S=mn(C,g,m,n);b.push({shape:k,color:S,rotation:h})}r(b)},o.onerror=t})}var Mn=j('<main class="svelte-1uha8ag"><!> <!></main>');function On(e,n){na(n,!1);let a=H("square"),l=H(ie.length>0?ie[0].rgb:"#000000"),r=H(null),t=H(!1),o=H("left"),F=H(1);function u(){T(F,Math.min(s(F)+.1,3))}function d(){T(F,Math.max(s(F)-.1,.2))}let b=H(!1);function p(h){T(a,h.detail.shape)}function v(h){T(l,h.detail.color)}async function D(h){const i=ie.map(c=>c.rgb);T(r,await wn(h.detail.src,i,32,32))}function f(h){T(b,h.detail.colorPickerMode)}function C(h){T(l,h.detail.color),T(b,!1)}ra();var g=Mn();xl(h=>{yl.title="Dotsly"});var m=E(g);Dn(m,{get toolbarPosition(){return s(o)},set toolbarPosition(h){T(o,h)},get selectedColor(){return s(l)},set selectedColor(h){T(l,h)},$$events:{shapeSelected:p,colorSelected:v,imageUploaded:D,paintModeToggled:h=>T(t,h.detail.paintMode),colorPickerModeToggled:f,zoomIn:u,zoomOut:d},$$legacy:!0});var M=I(m,2);{var L=h=>{Ba(h,{width:32,height:32,get selectedShape(){return s(a)},get selectedColor(){return s(l)},get grid(){return s(r)},get paintMode(){return s(t)},get colorPickerMode(){return s(b)},get toolbarPosition(){return s(o)},get zoom(){return s(F)},$$events:{colorPicked:C}})},k=h=>{Ba(h,{width:32,height:32,get selectedShape(){return s(a)},get selectedColor(){return s(l)},get paintMode(){return s(t)},get colorPickerMode(){return s(b)},get toolbarPosition(){return s(o)},get zoom(){return s(F)},$$events:{colorPicked:C}})};Fe(M,h=>{s(r)?h(L):h(k,!1)})}w(g),z(e,g),sa()}export{On as component};
