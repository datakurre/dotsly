import"../chunks/DsnmJJEf.js";import"../chunks/Cn1QM1BN.js";import{B as Fa,w as Pa,z as ye,o as q,ay as Sa,q as La,g as s,W as Oa,x as xa,H as Ha,y as aa,A as Ge,J as ve,ad as Ia,aG as Ra,C as Ne,F as Na,D as Fe,ac as la,a4 as V,aa as na,aD as ca,av as qa,aR as _e,G as ua,I as Va,aS as Be,aT as Ya,aU as Pe,al as da,ar as Ua,aV as Wa,aC as za,aW as Qa,T as Ka,aX as va,M as Xa,aY as Ja,aZ as Za,a_ as $a,a$ as ja,b0 as el,b1 as al,b2 as ll,b3 as nl,a6 as fa,b as P,L as sl,b4 as rl,i as z,t as re,k as L,m,n as B,p as Ye,b5 as qe,R as E,e as fe,b6 as ha,v as Se,j as Le,l as Ue,b7 as Oe,s as G,am as sa,b8 as ga,b9 as tl}from"../chunks/BaTXMALA.js";import{c as pa,e as W,s as xe,a as ol}from"../chunks/BEavlA6p.js";import{p as H,i as le,b as il}from"../chunks/5uDJtnhD.js";import{i as We}from"../chunks/DrJFlOKt.js";function be(e,a){return a}function Fl(e,a,l){for(var n=e.items,r=[],i=a.length,o=0;o<i;o++)Wa(a[o].e,r,!0);var c=i>0&&r.length===0&&l!==null;if(c){var F=l.parentNode;za(F),F.append(l),n.clear(),Z(e,a[0].prev,a[i-1].next)}Qa(r,()=>{for(var f=0;f<i;f++){var g=a[f];c||(n.delete(g.k),Z(e,g.prev,g.next)),da(g.e,!c)}})}function Ce(e,a,l,n,r,i=null){var o=e,c={flags:a,items:new Map,first:null},F=(a&va)!==0;if(F){var f=e;o=q?ye(Sa(f)):f.appendChild(Fa())}q&&La();var g=null,A=!1,_=new Map,w=Oa(()=>{var b=l();return qa(b)?b:b==null?[]:ca(b)}),d,p;function h(){cl(p,d,c,_,o,r,a,n,l),i!==null&&(d.length===0?g?ua(g):g=Ne(()=>i(o)):g!==null&&Va(g,()=>{g=null}))}Pa(()=>{p??=Ka,d=s(w);var b=d.length;if(A&&b===0)return;A=b===0;let t=!1;if(q){var T=xa(o)===Ha;T!==(b===0)&&(o=aa(),ye(o),Ge(!1),t=!0)}if(q){for(var D=null,C,v=0;v<b;v++){if(ve.nodeType===Ia&&ve.data===Ra){o=ve,t=!0,Ge(!1);break}var u=d[v],M=n(u,v);C=Ve(ve,c,D,null,u,M,v,r,a,l),c.items.set(M,C),D=C}b>0&&ye(aa())}if(q)b===0&&i&&(g=Ne(()=>i(o)));else if(Na()){var S=new Set,I=Fe;for(v=0;v<b;v+=1){u=d[v],M=n(u,v);var x=c.items.get(M)??_.get(M);x?(a&(Be|_e))!==0&&ba(x,u,v,a):(C=Ve(null,c,null,null,u,M,v,r,a,l,!0),_.set(M,C)),S.add(M)}for(const[y,X]of c.items)S.has(y)||I.skipped_effects.add(X.e);I.add_callback(h)}else h();t&&Ge(!0),s(w)}),q&&(o=ve)}function cl(e,a,l,n,r,i,o,c,F){var f=(o&Ja)!==0,g=(o&(Be|_e))!==0,A=a.length,_=l.items,w=l.first,d=w,p,h=null,b,t=[],T=[],D,C,v,u;if(f)for(u=0;u<A;u+=1)D=a[u],C=c(D,u),v=_.get(C),v!==void 0&&(v.a?.measure(),(b??=new Set).add(v));for(u=0;u<A;u+=1){if(D=a[u],C=c(D,u),v=_.get(C),v===void 0){var M=n.get(C);if(M!==void 0){n.delete(C),_.set(C,M);var S=h?h.next:d;Z(l,h,M),Z(l,M,S),He(M,S,r),h=M}else{var I=d?d.e.nodes_start:r;h=Ve(I,l,h,h===null?l.first:h.next,D,C,u,i,o,F)}_.set(C,h),t=[],T=[],d=h.next;continue}if(g&&ba(v,D,u,o),(v.e.f&Pe)!==0&&(ua(v.e),f&&(v.a?.unfix(),(b??=new Set).delete(v))),v!==d){if(p!==void 0&&p.has(v)){if(t.length<T.length){var x=T[0],y;h=x.prev;var X=t[0],ne=t[t.length-1];for(y=0;y<t.length;y+=1)He(t[y],x,r);for(y=0;y<T.length;y+=1)p.delete(T[y]);Z(l,X.prev,ne.next),Z(l,h,X),Z(l,ne,x),d=x,h=ne,u-=1,t=[],T=[]}else p.delete(v),He(v,d,r),Z(l,v.prev,v.next),Z(l,v,h===null?l.first:h.next),Z(l,h,v),h=v;continue}for(t=[],T=[];d!==null&&d.k!==C;)(d.e.f&Pe)===0&&(p??=new Set).add(d),T.push(d),d=d.next;if(d===null)continue;v=d}t.push(v),h=v,d=v.next}if(d!==null||p!==void 0){for(var Y=p===void 0?[]:ca(p);d!==null;)(d.e.f&Pe)===0&&Y.push(d),d=d.next;var ae=Y.length;if(ae>0){var Q=(o&va)!==0&&A===0?r:null;if(f){for(u=0;u<ae;u+=1)Y[u].a?.measure();for(u=0;u<ae;u+=1)Y[u].a?.fix()}Fl(l,Y,Q)}}f&&Xa(()=>{if(b!==void 0)for(v of b)v.a?.apply()}),e.first=l.first&&l.first.e,e.last=h&&h.e;for(var te of n.values())da(te.e);n.clear()}function ba(e,a,l,n){(n&Be)!==0&&la(e.v,a),(n&_e)!==0?la(e.i,l):e.i=l}function Ve(e,a,l,n,r,i,o,c,F,f,g){var A=(F&Be)!==0,_=(F&Ya)===0,w=A?_?V(r,!1,!1):na(r):r,d=(F&_e)===0?o:na(o),p={i:d,v:w,k:i,a:null,e:null,prev:l,next:n};try{if(e===null){var h=document.createDocumentFragment();h.append(e=Fa())}return p.e=Ne(()=>c(e,w,d,f),q),p.e.prev=l&&l.e,p.e.next=n&&n.e,l===null?g||(a.first=p):(l.next=p,l.e.next=p.e),n!==null&&(n.prev=p,n.e.prev=p.e),p}finally{}}function He(e,a,l){for(var n=e.next?e.next.e.nodes_start:l,r=a?a.e.nodes_start:l,i=e.e.nodes_start;i!==null&&i!==n;){var o=Ua(i);r.before(i),i=o}}function Z(e,a,l){a===null?e.first=l:(a.next=l,a.e.next=l&&l.e),l!==null&&(l.prev=a,l.e.prev=a&&a.e)}const ra=[...` 	
\r\f \v\uFEFF`];function ul(e,a,l){var n=e==null?"":""+e;if(a&&(n=n?n+" "+a:a),l){for(var r in l)if(l[r])n=n?n+" "+r:r;else if(n.length)for(var i=r.length,o=0;(o=n.indexOf(r,o))>=0;){var c=o+i;(o===0||ra.includes(n[o-1]))&&(c===n.length||ra.includes(n[c]))?n=(o===0?"":n.substring(0,o))+n.substring(c+1):o=c}}return n===""?null:n}function dl(e,a){return e==null?null:String(e)}function se(e,a,l,n,r,i){var o=e.__className;if(q||o!==l||o===void 0){var c=ul(l,n,i);(!q||c!==e.getAttribute("class"))&&(c==null?e.removeAttribute("class"):e.className=c),e.__className=l}else if(i&&r!==i)for(var F in i){var f=!!i[F];(r==null||f!==!!r[F])&&e.classList.toggle(F,f)}return i}function ce(e,a,l,n){var r=e.__style;if(q||r!==a){var i=dl(a);(!q||i!==e.getAttribute("style"))&&(i==null?e.removeAttribute("style"):e.style.cssText=i),e.__style=a}return n}const vl=Symbol("is custom element"),fl=Symbol("is html");function hl(e){if(q){var a=!1,l=()=>{if(!a){if(a=!0,e.hasAttribute("value")){var n=e.value;O(e,"value",null),e.value=n}if(e.hasAttribute("checked")){var r=e.checked;O(e,"checked",null),e.checked=r}}};e.__on_r=l,al(l),ll()}}function O(e,a,l,n){var r=gl(e);q&&(r[a]=e.getAttribute(a),a==="src"||a==="srcset"||a==="href"&&e.nodeName==="LINK")||r[a]!==(r[a]=l)&&(a==="loading"&&(e[Za]=l),l==null?e.removeAttribute(a):typeof l!="string"&&pl(e).includes(a)?e[a]=l:e.setAttribute(a,l))}function gl(e){return e.__attributes??={[vl]:e.nodeName.includes("-"),[fl]:e.namespaceURI===$a}}var ta=new Map;function pl(e){var a=e.getAttribute("is")||e.nodeName,l=ta.get(a);if(l)return l;ta.set(a,l=[]);for(var n,r=e,i=Element.prototype;i!==r;){n=el(r);for(var o in n)n[o].set&&l.push(o);r=ja(r)}return l}function bl(e,a,l=a){var n=new WeakSet;nl(e,"input",async r=>{var i=r?e.defaultValue:e.value;if(i=Ie(e)?Re(i):i,l(i),Fe!==null&&n.add(Fe),await fa(),i!==(i=a())){var o=e.selectionStart,c=e.selectionEnd;e.value=i??"",c!==null&&(e.selectionStart=o,e.selectionEnd=Math.min(c,e.value.length))}}),(q&&e.defaultValue!==e.value||P(a)==null&&e.value)&&(l(Ie(e)?Re(e.value):e.value),Fe!==null&&n.add(Fe)),sl(()=>{var r=a();if(e===document.activeElement){var i=rl??Fe;if(n.has(i))return}Ie(e)&&r===Re(e.value)||e.type==="date"&&!r&&!e.value||r!==e.value&&(e.value=r??"")})}function Ie(e){var a=e.type;return a==="number"||a==="range"}function Re(e){return e===""?null:+e}var Cl=z('<div class="square svelte-gxsx5p"></div>');function Ca(e,a){let l=H(a,"color",8,"#000");var n=Cl();re(()=>ce(n,`--color: ${l()??""}`)),L(e,n)}var _l=z('<div class="circle svelte-r5z0cw"></div>');function _a(e,a){let l=H(a,"color",8,"#000");var n=_l();re(()=>ce(n,`--color: ${l()??""}`)),L(e,n)}var Bl=z('<div class="arch-container svelte-1isloo0"><svg width="100%" height="100%" viewBox="0 0 100 100" preserveAspectRatio="none"><circle cx="0" cy="0" r="100"></circle></svg></div>');function Ba(e,a){let l=H(a,"color",8,"#000"),n=H(a,"rotation",8,0);var r=Bl(),i=m(r),o=m(i);B(i),B(r),re(()=>{ce(r,`transform: rotate(${n()*90}deg);`),O(o,"fill",l())}),L(e,r)}const ml=`Part,Color,Quantity,Is Spare
3070b,0,20,False
24246,0,20,False
25269,0,20,False
3070b,1,30,False
...
`);return a[0].split(","),a.slice(1).map(l=>{const n=l.split(",");return{id:Number(n[0]),name:n[1],rgb:`#${n[2]}`,is_trans:n[3]==="True"}})}function wl(e){let a=0,l=0,n=0;e.length===7?(a=parseInt(e.slice(1,3),16),l=parseInt(e.slice(3,5),16),n=parseInt(e.slice(5,7),16)):e.length===4&&(a=parseInt(e[1]+e[1],16),l=parseInt(e[2]+e[2],16),n=parseInt(e[3]+e[3],16)),a/=255,l/=255,n/=255;const r=Math.max(a,l,n),i=Math.min(a,l,n);let o=0,c=0,F=(r+i)/2;if(r!==i){const f=r-i;switch(c=F>.5?f/(2-r-i):f/(r+i),r){case a:o=(l-n)/f+(l<n?6:0);break;case l:o=(n-a)/f+2;break;case n:o=(a-l)/f+4;break}o/=6}return{h:o*360,s:c*100,l:F*100}}function El(e,a=15,l=5){const n={},r=new Set;for(const F of e){const f=F.s<10?999:Math.floor(F.h/a);n[f]||(n[f]=[]),r.has(F.rgb)||(n[f].push(F),r.add(F.rgb))}Object.values(n).forEach(F=>F.sort((f,g)=>f.l-g.l));const o=Object.keys(n).map(Number).sort((F,f)=>F-f).flatMap(F=>n[F]),c=[];for(let F=0;F<o.length;F+=l)c.push(o.slice(F,F+l));return c}function yl(){const e=new Set;for(const a in oa){const n=oa[a].trim().split(`
`);for(const r of n.slice(1)){const i=r.split(",");if(i.length>1){const o=Number(i[1]);isNaN(o)||e.add(o)}}}return e}const Gl=yl(),ee=Ml(Tl).filter(e=>Gl.has(e.id));function Pl(){return ee.map(e=>{const a=wl(e.rgb);return{...e,...a}})}const Sl=El(Pl());var Ll=z('<div class="cell svelte-1w4104m" role="button" tabindex="0"><!></div>'),Ol=z('<div><div class="grid svelte-1w4104m"></div></div>');function ia(e,a){Ye(a,!1);let l=H(a,"paintMode",8,!1),n=H(a,"colorPickerMode",8,!1),r=H(a,"toolbarPosition",8,"left");const i=pa();function o(b){const t=s(_)[b];if(!t)return w(b);const{shape:T,color:D}=t;if(T===g()&&D===A())return;const C=[b],v=new Set;for(;C.length;){const u=C.pop();if(u===void 0||v.has(u))continue;v.add(u);const M=s(_)[u];if(!M||M.shape!==T||M.color!==D)continue;Oe(_,s(_)[u]={shape:g(),color:A(),rotation:0});const S=u%F(),I=Math.floor(u/F());S>0&&C.push(u-1),S<F()-1&&C.push(u+1),I>0&&C.push(u-F()),I<f()-1&&C.push(u+F())}E(_,[...s(_)])}let c=H(a,"grid",8,null),F=H(a,"width",8,32),f=H(a,"height",8,32),g=H(a,"selectedShape",8,"square"),A=H(a,"selectedColor",24,()=>ee.length>0?ee[0].rgb:"#000000"),_=V();function w(b){const t=s(_)[b];t&&t.shape==="arch"&&t.color===A()?Oe(_,s(_)[b]={...t,rotation:(t.rotation+1)%4}):Oe(_,s(_)[b]={shape:g(),color:A(),rotation:0}),E(_,[...s(_)])}function d(b){const t=s(_)[b];t&&t.color&&i("colorPicked",{color:t.color})}qe(()=>(fe(c()),fe(F()),fe(f())),()=>{E(_,c()||Array(F()*f()).fill(null))}),ha(),We();var p=Ol(),h=m(p);Ce(h,5,()=>s(_),be,(b,t,T)=>{var D=Ll(),C=m(D);{var v=u=>{var M=Se(),S=Le(M);{var I=y=>{Ca(y,{get color(){return s(t),P(()=>s(t).color)}})},x=y=>{var X=Se(),ne=Le(X);{var Y=Q=>{_a(Q,{get color(){return s(t),P(()=>s(t).color)}})},ae=Q=>{var te=Se(),oe=Le(te);{var he=ie=>{Ba(ie,{get color(){return s(t),P(()=>s(t).color)},get rotation(){return s(t),P(()=>s(t).rotation)}})};le(oe,ie=>{s(t),P(()=>s(t).shape==="arch")&&ie(he)},!0)}L(Q,te)};le(ne,Q=>{s(t),P(()=>s(t).shape==="circle")?Q(Y):Q(ae,!1)},!0)}L(y,X)};le(S,y=>{s(t),P(()=>s(t).shape==="square")?y(I):y(x,!1)})}L(u,M)};le(C,u=>{s(t)&&u(v)})}B(D),W("click",D,()=>n()?d(T):l()?o(T):w(T)),W("keydown",D,u=>{u.key==="Enter"&&(n()?d(T):l()?o(T):w(T))}),L(b,D)}),B(h),B(p),re(()=>{se(p,1,`container ${r()==="left"?"toolbar-left-margin":"toolbar-top-margin"}`,"svelte-1w4104m"),ce(h,`--width: ${F()??""}; --height: ${f()??""};`)}),L(e,p),Ue()}var xl=ga('<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#555" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align: middle;"><polyline points="4 12 4 4 12 4"></polyline><line x1="4" y1="4" x2="20" y2="20"></line></svg>'),Hl=ga('<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#555" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align: middle;"><polyline points="12 4 20 4 20 12"></polyline><line x1="4" y1="4" x2="20" y2="20"></line></svg>'),Il=z('<button type="button" class="dropdown-item" style="display: flex; align-items: center; width: 100%; background: none; border: none; padding: 0; text-align: left; cursor: pointer;"><span class="dropdown-swatch"></span> <span> </span> <span style="margin-left:auto; color:#888; font-size:0.9em"> </span></button>'),Rl=z('<div class="dropdown-item">No colors found</div>'),Nl=z('<div class="dropdown-menu"><input type="text" placeholder="Search color..." class="dropdown-search"/> <div class="dropdown-list"><!> <!></div></div>'),ql=z('<button type="button"></button>'),Vl=z('<div class="palette-row"></div>'),Yl=z('<div><button class="toolbar-toggle"><!></button> <div class="shape-group"><div class="group-label">Shapes</div> <div class="shape-grid"><button aria-label="Square" title="Square - Draw square shapes"><div class="shape-icon"><!></div></button> <button aria-label="Circle" title="Circle - Draw circular shapes"><div class="shape-icon"><!></div></button> <button aria-label="Arch" title="Arch - Draw arch shapes"><div class="shape-icon"><!></div></button></div></div> <div class="tool-group"><div class="group-label">Tools</div> <div class="tool-grid"><button type="button" aria-label="Paint roller tool" title="Fill Tool - Fill areas with selected color"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="6" y="4" width="10" height="4" rx="1.5"></rect><path d="M16 6v4c0 1-1 2-2 2H10c-1 0-2-1-2-2V6"></path><rect x="11" y="14" width="2" height="5" rx="1"></rect><path d="M12 12v2"></path></svg></button> <button type="button" aria-label="Pick color from canvas" title="Color Picker - Click to pick colors from the canvas"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="7" stroke-width="2"></circle><path d="M12 9v3l2 2" stroke-width="2"></path></svg></button></div></div> <div class="color-dropdown-container"><button type="button" class="dropdown-toggle"> <span style="margin-left:0.5em;">▼</span></button> <!></div> <div class="colors"><div class="palette2d"></div></div> <div class="image-upload"><label class="upload-label"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#555" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align: middle;"><path d="M12 16V4"></path><polyline points="8 8 12 4 16 8"></polyline><rect x="4" y="16" width="16" height="4" rx="2"></rect></svg> <span>Upload image</span> <input type="file" accept="image/png, image/jpeg"/></label></div></div>');function Ul(e,a){Ye(a,!1);let l=V(null),n=V(!1),r=H(a,"colorPickerMode",12,!1);function i(){E(n,!s(n)),s(n)&&r(!1),F("paintModeToggled",{paintMode:s(n)})}function o(){r(!r()),r()&&E(n,!1),F("colorPickerModeToggled",{colorPickerMode:r()})}function c(k){g(k),F("colorSelected",{color:k})}const F=pa();let f=H(a,"selectedShape",12,"square"),g=H(a,"selectedColor",28,()=>ee.length>0?ee[0].rgb:"#000000");function A(k){f(k),F("shapeSelected",{shape:k})}function _(k){const R=k.target,U=R.files&&R.files[0];if(U){const J=new FileReader;J.onload=()=>{F("imageUploaded",{src:J.result})},J.readAsDataURL(U)}}let w=V(""),d=V(!1),p=ee,h=V(p);function b(k){g(k.rgb),E(d,!1),E(w,""),F("colorSelected",{color:k.rgb})}let t=V("left");function T(){E(t,s(t)==="left"?"top":"left")}qe(()=>(s(d),s(l)),()=>{s(d)&&fa().then(()=>{s(l)?.focus()})}),qe(()=>s(w),()=>{E(h,s(w).trim()?p.filter(k=>k.name.toLowerCase().includes(s(w).toLowerCase())||k.rgb.replace("#","").includes(s(w).replace("#",""))):p)}),ha(),We();var D=Yl(),C=m(D),v=m(C);{var u=k=>{var R=xl();L(k,R)},M=k=>{var R=Hl();L(k,R)};le(v,k=>{s(t)==="left"?k(u):k(M,!1)})}B(C);var S=G(C,2),I=G(m(S),2),x=m(I);let y;var X=m(x),ne=m(X);Ca(ne,{get color(){return g()}}),B(X),B(x);var Y=G(x,2);let ae;var Q=m(Y),te=m(Q);_a(te,{get color(){return g()}}),B(Q),B(Y);var oe=G(Y,2);let he;var ie=m(oe),ma=m(ie);Ba(ma,{get color(){return g()},rotation:0}),B(ie),B(oe),B(I),B(S);var me=G(S,2),ze=G(m(me),2),ue=m(ze);let Qe;var De=m(ue),ke=m(De),Ke=G(ke),Ae=G(Ke),Da=G(Ae);B(De),B(ue);var ge=G(ue,2);let Xe;var Te=m(ge),ka=m(Te);sa(),B(Te),B(ge),B(ze),B(me);var Me=G(me,2),pe=m(Me),Aa=m(pe);sa(),B(pe);var Ta=G(pe,2);{var Ma=k=>{var R=Nl(),U=m(R);hl(U),il(U,j=>E(l,j),()=>s(l));var J=G(U,2),N=m(J);Ce(N,1,()=>s(h),be,(j,K)=>{var de=Il(),je=m(de),Ee=G(je,2),ya=m(Ee,!0);B(Ee);var ea=G(Ee,2),Ga=m(ea,!0);B(ea),B(de),re(()=>{O(de,"aria-label",(s(K),P(()=>`Select color ${s(K).name}`))),ce(je,`background:${s(K),P(()=>s(K).rgb)??""}`),xe(ya,(s(K),P(()=>s(K).name))),xe(Ga,(s(K),P(()=>s(K).rgb)))}),W("click",de,()=>b(s(K))),L(j,de)});var $=G(N,2);{var Ea=j=>{var K=Rl();L(j,K)};le($,j=>{s(h),P(()=>s(h).length===0)&&j(Ea)})}B(J),B(R),bl(U,()=>s(w),j=>E(w,j)),L(k,R)};le(Ta,k=>{s(d)&&k(Ma)})}B(Me);var we=G(Me,2),Je=m(we);Ce(Je,5,()=>Sl,be,(k,R)=>{var U=Vl();Ce(U,5,()=>s(R),be,(J,N)=>{var $=ql();re(()=>{ce($,`width: 1.5rem; height: 1.5rem; background: ${s(N),P(()=>s(N).rgb)??""}; border: 2px solid ${fe(g()),s(N),P(()=>g()===s(N).rgb?"#333":"#ccc")??""}; border-radius: 0.25rem; cursor: pointer; margin: 0 0.1rem 0.1rem 0;`),O($,"aria-label",(s(N),P(()=>s(N).name))),O($,"title",(s(N),P(()=>s(N).name)))}),W("click",$,()=>c(s(N).rgb)),L(J,$)}),B(U),L(k,U)}),B(Je),B(we);var Ze=G(we,2),$e=m(Ze),wa=G(m($e),4);B($e),B(Ze),B(D),re((k,R,U,J,N,$)=>{se(D,1,`toolbar ${s(t)??""}`),O(C,"aria-label",s(t)==="left"?"Move toolbar to top":"Move toolbar to left"),y=se(x,1,"shape-button",null,y,k),ae=se(Y,1,"shape-button",null,ae,R),he=se(oe,1,"shape-button",null,he,U),Qe=se(ue,1,"tool-button",null,Qe,J),O(De,"stroke",s(n)?"#333":"#888"),O(ke,"fill",s(n)?"#f4d23e":"#fff"),O(ke,"stroke",s(n)?"#333":"#888"),O(Ke,"stroke",s(n)?"#333":"#888"),O(Ae,"fill",s(n)?"#f4d23e":"#fff"),O(Ae,"stroke",s(n)?"#333":"#888"),O(Da,"stroke",s(n)?"#333":"#888"),Xe=se(ge,1,"tool-button",null,Xe,N),O(Te,"stroke",r()?"#333":"#888"),O(ka,"fill",r()?"#aef":"#fff"),xe(Aa,`${$??""} `)},[()=>({selected:f()==="square"}),()=>({selected:f()==="circle"}),()=>({selected:f()==="arch"}),()=>({active:s(n)}),()=>({active:r()}),()=>(fe(g()),P(()=>g()?p.find(k=>k.rgb===g())?.name||g():"Select color..."))]),W("click",C,T),W("click",x,()=>A("square")),W("click",Y,()=>A("circle")),W("click",oe,()=>A("arch")),W("click",ue,i),W("click",ge,o),W("click",pe,()=>E(d,!s(d))),W("change",wa,_),L(e,D),Ue()}function Wl(e){e=e.replace(/^#/,""),e.length===3&&(e=e.split("").map(l=>l+l).join(""));const a=parseInt(e,16);return{r:a>>16&255,g:a>>8&255,b:a&255}}function zl(e,a,l,n){let r=n[0],i=1/0;for(const o of n){const c=Wl(o),F=Math.sqrt(Math.pow(e-c.r,2)+Math.pow(a-c.g,2)+Math.pow(l-c.b,2));F<i&&(i=F,r=o)}return r}function Ql(e){return e<85?"square":e<170?"arch":"circle"}function Kl(e,a,l=32,n=32){return new Promise((r,i)=>{const o=new window.Image;o.src=e,o.onload=()=>{const c=document.createElement("canvas"),F=c.getContext("2d");if(c.width=l,c.height=n,!F){i(new Error("Could not get 2D context"));return}F.drawImage(o,0,0,l,n);const f=F.getImageData(0,0,l,n).data,g=[];for(let A=0;A<f.length;A+=4){const _=A/4,w=_%l,d=Math.floor(_/l);let p=f[A],h=f[A+1],b=f[A+2];f[A+3]===0&&(p=255,h=255,b=255);const T=(p+h+b)/3;let D=Ql(T),C=0;const v=d===0,u=d===n-1,M=w===0,S=w===l-1;D==="arch"&&(v||u||M||S)?v?C=2:u?C=0:M?C=1:S&&(C=3):D==="arch"&&(D=T<128?"square":"circle");const I=zl(p,h,b,a);g.push({shape:D,color:I,rotation:C})}r(g)},o.onerror=i})}var Xl=z('<main class="svelte-1uha8ag"><!> <!></main>');function l0(e,a){Ye(a,!1);let l=V("square"),n=V(ee.length>0?ee[0].rgb:"#000000"),r=V(null),i=V(!1),o=V("left"),c=V(!1);function F(t){E(l,t.detail.shape)}function f(t){E(n,t.detail.color)}async function g(t){const T=ee.map(D=>D.rgb);E(r,await Kl(t.detail.src,T,32,32))}function A(t){E(c,t.detail.colorPickerMode)}function _(t){E(n,t.detail.color),E(c,!1)}We();var w=Xl();ol(t=>{tl.title="Dotsly"});var d=m(w);Ul(d,{get toolbarPosition(){return s(o)},set toolbarPosition(t){E(o,t)},get selectedColor(){return s(n)},set selectedColor(t){E(n,t)},$$events:{shapeSelected:F,colorSelected:f,imageUploaded:g,paintModeToggled:t=>E(i,t.detail.paintMode),colorPickerModeToggled:A},$$legacy:!0});var p=G(d,2);{var h=t=>{ia(t,{width:32,height:32,get selectedShape(){return s(l)},get selectedColor(){return s(n)},get grid(){return s(r)},get paintMode(){return s(i)},get colorPickerMode(){return s(c)},get toolbarPosition(){return s(o)},$$events:{colorPicked:_}})},b=t=>{ia(t,{width:32,height:32,get selectedShape(){return s(l)},get selectedColor(){return s(n)},get paintMode(){return s(i)},get colorPickerMode(){return s(c)},get toolbarPosition(){return s(o)},$$events:{colorPicked:_}})};le(p,t=>{s(r)?t(h):t(b,!1)})}B(w),L(e,w),Ue()}export{l0 as component};
